...
Name | Type | Descrption
--- | --- | ---
`IsEnabled_bool` | `boolean` | Active flag
`Message_utf` | `string` (UTF8) | Message
`Owner_utf` | `string` (UTF8) | Owner name
`Abuse_utf` | `string` (UTF8) | Abuse email
`NoLog_bool` | `boolean` | Log save flag
`LogPermanent_bool` | `boolean` | Save log permanently
