...
OPTIONS_LINK_DEBUG=-g -L/usr/local/lib -fsigned-char -m64 -lm -lpthread -lssl -lcrypto -liconv -lreadline -lncurses -lz
...
OPTIONS_LINK_RELEASE=-O2 -L/usr/local/lib -fsigned-char -m64 -lm -lpthread -lssl -lcrypto -liconv -lreadline -lncurses -lz
